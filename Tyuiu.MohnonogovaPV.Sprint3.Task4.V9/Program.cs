using Tyuiu.MohnonogovaPV.Sprint3.Task4.V9.Lib;
namespace Tyuiu.MohnonogovaPV.Sprint3.Task4.V9
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* y=x/(cos(x) - x).   При х = 0 пропустить значение. Полученные значения перемножать.      *");
            Console.WriteLine("*                                                                                          *");
